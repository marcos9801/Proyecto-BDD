...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Asegúrate de que el elemento con el id "submit" esté presente en el documento HTML
    document.getElementById("botonGuardar").addEventListener('click', agregarProducto);
});
