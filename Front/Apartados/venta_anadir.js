...
async function guardarVenta(event) {
    ...
    const fecha_apartado = document.getElementById('fecha_apartado').value;
    const fecha_limite = document.getElementById('fecha_limite_apartado').value;
    const detalle_venta = [];
...
async function obtenerProductos() {
    try {
        ...
        for (let i = 0; i < productos.length; i++) {
            ...
            document.getElementById('detalle_apartado').appendChild(option);
        }
    } catch (error) {
